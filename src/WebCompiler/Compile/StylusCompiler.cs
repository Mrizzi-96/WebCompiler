...
namespace WebCompiler
{
    ...
    {
        private static Regex _errorRx = new Regex(@"(?<severity>Error|Warning): (?<file>.+.styl):(?<line>[0-9]+):(?<column>[0-9]+)(?<message>.+)", RegexOptions.Compiled | RegexOptions.Multiline | RegexOptions.Singleline); private string _path;
